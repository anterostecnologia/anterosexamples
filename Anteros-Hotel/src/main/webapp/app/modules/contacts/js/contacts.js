angular.module('PilukuApp.contacts', [
  'ui.router'
])
    ...
    function ($stateProvider,   $urlRouterProvider) {
      $stateProvider
        ...
        .state('contacts', {
          ...
          // within index.html.
          templateUrl: appHelper.componentView('contacts','index'),
        ...
        .state('contacts.list', {
          ...
          templateUrl: appHelper.componentView('contacts','contacts.list'),
        })
        ...
        .state('contacts.detail', {
          ...
          views: {
            ...
            '': {
              templateUrl: appHelper.componentView('contacts','detail'),
        ...
        .state('contacts.detail.item', {
          ...
          views: {
            ...
            '': {
              templateUrl:appHelper.componentView('contacts','detail.item'),
        ...
        .state('contacts.detail.item.edit', {
          views: {
            ...
            '@contacts.detail': {
              templateUrl: appHelper.componentView('contacts','detail.item.edit'),
              controller: ['$scope', '$stateParams', '$state', 'utils',
                function (  $scope,   $stateParams,   $state,   utils) {
                  $scope.item = utils.findById($scope.contact.items, $stateParams.itemId);
                  $scope.done = function () {
