...
public class AnterosHotelPersistenceConfiguration extends AnterosSpringPersistenceConfiguration{
	...
	public SQLSessionFactoryConfiguration getSQLSessionFactoryConfiguration() {
		return SQLSessionFactoryConfiguration.create()
				.packageScanEntity(new PackageScanEntity("br.com.anteros.demo.hotel.model*"))
